...
from furniture_engine.models import PlacedFurniture, Room, Wall
...
def hits_furniture(
    item: PlacedFurniture, others: list[PlacedFurniture]
...
def check_placement(
    item: PlacedFurniture, room: Room, others: list[PlacedFurniture]
) -> str | None:
    """統一檢查入口,回傳 None 表示合法,否則回傳失敗原因"""
