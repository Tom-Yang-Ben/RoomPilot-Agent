...
比對基準:testdata/dxf_scale/floorXX.dxf(公分 DXF)經 parse_dxf_file 解析後,
每扇窗應收斂成「一條」中心線段;testdata/json/floorXX.json 的 windows(每扇一筆,
...
執行:uv run python roompilot/upgrade3d/eval_window_merge.py
"""
import glob
import json
import math
...
from roompilot.upgrade3d.dxf_parser import parse_dxf_file  # noqa: E402
