...
- 第 5 步依序收集居住者資料、依空間分類的極與極需求，以及風格、牆面、地板、天花板材質與色卡。逐房需求就是極與極問卷，不另外要求使用者填寫一套家具勾選表。題庫共有 55 組，頁面會依已確認的空間類型顯示相關題目。
...
- 平面圖辨識以 Cody 流程為主，支援兩點尺度校正、OCR 房名、家具圖示輔助空間命名、牆門窗與結構確認；圖示推測不覆蓋 OCR，低信心或衝突結果須由使用者確認。
