...
- Catalog 共 8,557 筆家具，其中 7,958 筆為 active／RAG-indexable，599 筆保留複核且不進正式 API／RAG。
- GLB 8,557 筆、三視角圖片 25,671 筆，合計 34,228 筆資產紀錄。
- BGE-M3 正式向量 7,958 筆；Django 負責 RAG metadata／文字、向量生成、檢索與品質，Kai 在 RAG 流程只負責把交付向量存入 PostgreSQL／pgvector。
