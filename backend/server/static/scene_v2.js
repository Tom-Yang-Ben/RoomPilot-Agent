import { createSceneViewer } from "./scene_viewer.js?v=sha256-b97245564184";
...
import {
  ...
  wallBoundarySide,
  windowsOverlap,
} from "./scene_structure_utils.js?v=sha256-89991601b362";
...
function applyWholeHouseFinishes() {
  ...
  state.rooms.forEach((room) => {
    ...
    state.roomFinishDrafts[room.id] = { ...draft, confirmed: true };
  });
  applyWholeHouseSurfaceConsistency();
}
