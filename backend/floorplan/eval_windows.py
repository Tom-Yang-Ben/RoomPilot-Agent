...
# -*- coding: utf-8 -*-
"""
eval_windows.py — 用 testdata/Identify_ans/pngans/gray/ 的人工標準答案評分 training/chk/gray/ 的窗戶偵測結果

    python3 eval_windows.py [答案目錄] [chk目錄]     (預設 testdata/Identify_ans/pngans/gray/ training/chk/gray/)
