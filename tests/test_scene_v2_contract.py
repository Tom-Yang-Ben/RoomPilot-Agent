...
def test_project_resume_restores_flow_rooms_and_generated_scene() -> None:
    ...
    assert "layout_2d: layoutIsLive" in source
    assert "schemeSet: state.layoutSchemeSet" in source
    assert "activeSchemeId: state.layoutSchemeSet?.activeSchemeId" in source
